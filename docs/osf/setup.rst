...
**If you need to develop authentication-related features, there is a process for setting up the full CAS server `https://github.com/CenterForOpenScience/docker-library/tree/master/cas`_.
